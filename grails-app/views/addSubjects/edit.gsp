        ...
        <g:form controller="addSubjects" action="update" width="300" name="formSave">
            ...
            <div>
                <div id="tabs" style="background-color: white; background: none">
                    ...
                    <div id="tabs-1">
                        <g:render template="/template/planSubject/addSubjectInGeneral" model="[subject: subject]"/>
                    </div>

                    <div id="tabs-2">
                        <g:render template="/template/subject/addSubjects"
                                  model="[ 'semesterCount' : plan.semestrCount, 'newControls':controls, 'hours':hours]"/></div>
                </div>
